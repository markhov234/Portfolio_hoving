    ...
    <section className="o-contact max-width-1600px">
      ...
      <div className="o-contact-zone">
        <section className="o-contact-content">
          <h3 className="o-contact-form-title">Quelques choses à me dire ?</h3>
          <form
          ...
          <div>
            ...
            <ul className="o-contact-medialink-list">
              {ProjectsData.reseaux.map((reseau) => (
                <li
                  className={`o-contact-medialink-item ${reseau.name}`}
                  key={reseau.name}
                >
                  <a
                    target="_blank"
...
export default OrganismContactSideBar;
